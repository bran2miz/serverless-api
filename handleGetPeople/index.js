...
exports.handler = async (event) => {
  ...
  try {
    ...
    // response.body = (all the good stuff from the table)
    response.body = JSON.stringify(results)
  } catch (e) {
    // if I am not successful in getting from my table I will send back status 500
    // body will be the error message
